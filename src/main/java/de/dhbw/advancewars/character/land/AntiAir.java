...
public class AntiAir implements ICharacter {
    ...
    /**
     * Create a new Anti-Air character.
     *
     * @param playerSide The side of the player.
     */
    public AntiAir(PlayerSide playerSide) {
    ...
    public String getCharacterAssetPath() {
        if (this.side == PlayerSide.PLAYER_1) {
            return "/assets/units_blue/anti-air.png";
        }
        return "/assets/units_red/anti-air.png";
    }
